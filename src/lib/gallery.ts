...
export const galleryImages: GalleryImage[] = [
  ...
  {
    id: 'burger-2',
    src: '/chipotle-burger-opt.jpeg',
    alt: 'Chipotle Burger, Stella Pizza Cherry Hill NJ',
    category: 'burgers',
  ...
  {
    id: 'poppers-1',
    src: '/poppers-opt.jpeg',
    alt: 'Jalapeno Poppers, Stella Pizza Cherry Hill NJ',
    category: 'appetizers',
  ...
  {
    id: 'vodka-1',
    src: '/penne-vodka-opt.jpeg',
    alt: 'Penne Vodka, Stella Pizza Cherry Hill NJ',
    category: 'pasta',
    title: 'Penne Vodka',
    aspect: 'portrait',
  },
  {
    id: 'mozz-1',
    src: '/mozz-sticks-opt.jpeg',
    alt: 'Mozzarella Sticks, Stella Pizza Cherry Hill NJ',
    category: 'appetizers',
  ...
  {
    id: 'rolls-1',
    src: '/ny-style-rolls-opt.jpeg',
    alt: 'New York Style Counter Rolls, Stella Pizza Cherry Hill NJ',
    category: 'pizza',
    title: 'NY Style Rolls',
    aspect: 'portrait',
  },
  {
    id: 'margherita-1',
    src: '/margherita-opt.jpeg',
    alt: 'Margherita Pizza, Stella Pizza Cherry Hill NJ',
    category: 'pizza',
    title: 'Margherita',
    aspect: 'square',
  },
  ...
  {
    id: 'calzone-1',
    src: '/calzone-opt.jpeg',
    alt: 'Calzone, Stella Pizza Cherry Hill NJ',
    category: 'strombolis',
    title: 'Calzone',
    aspect: 'portrait',
  },
  {
    id: 'cheese-fries-1',
    src: '/cheese-fries-opt.jpeg',
    alt: 'Cheese Fries, Stella Pizza Cherry Hill NJ',
    category: 'appetizers',
    title: 'Cheese Fries',
    aspect: 'portrait',
  },
  {
    id: 'chef-salad-1',
    src: '/chef-salad-opt.jpeg',
    alt: 'Chef Salad, Stella Pizza Cherry Hill NJ',
    category: 'salads',
    title: 'Chef Salad',
    aspect: 'portrait',
  },
  {
    id: 'greco-salad-1',
    src: '/greek-salad-opt.jpeg',
    alt: 'Greek Salad, Stella Pizza Cherry Hill NJ',
    category: 'salads',
    title: 'Greek Salad',
    aspect: 'portrait',
  },
  {
    id: 'alfredo-1',
    src: '/fettucine-alfredo-opt.jpeg',
    alt: 'Fettucine Alfredo, Stella Pizza Cherry Hill NJ',
    category: 'pasta',
